...
/* Ask the browser to mark this origin's storage as persistent, so the OS
   does not evict it to reclaim space. Safari and Chrome both honour this
   for installed PWAs. */
...
} trace(pid); toast('Outflows tagged');
}
...
} toast(id?'Outflow updated':'Outflow added');
}
function delFlow(id){
